    ...
    <section>
        ...
        <div class="bd-highlight mt-5 px-5">
            ...
            <div class="d-flex justify-content-end">
                ...
                <a href="D_Excel.php"> <button type="button" data-bs-toggle="modal" data-bs-target="#exampleModal" class="btn btn-info btn-lg hov">
        ...
        <div class="modal fade " id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
            <div class="modal-dialog ">
                <div class="modal-content text-light bg-dark">
                    ...
                    <div class="modal-body">
                        <form action="/Inventory/php/D_Script.php" method="POST">
                            <fieldset>
            ...
            Array.from(deletes).forEach((element) => {
                element.addEventListener("click", (e) => {
                    ...
                    if (confirm("You want to delete this record?")) {
                        console.log("yes");
                        window.location = `/Inventory/php/D_Script.php?delete=${sno}`;
                    }
