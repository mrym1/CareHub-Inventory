...
if (isset($_POST['submit'])) {
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if ($new_Password == $c_Password) {
            ...
            $pin = $_SESSION['F_PIN'];
            $update_pw = "UPDATE `USER` SET `PASSWORD` = '$new_Password' WHERE `USER`.`PIN_CODE`= '$pin' ";
            ...
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                ...
                header("location:/Inventory/php/User_login.php?error=0");
            } 
            else {
            ...
            <div class="col-12 col-lg-5 col-md-8 col-xxl-5">
                <div class="login py-3 px-2">
                    <div class="data">
                        ...
                        <form action="/Inventory/php/U_forget.php" method="POST" class="mt-5 text-center">
                            ...
                            <div class="text-center mt-3">
                                ...
                                <a href="/Inventory/php/User_login.php"><button type="button" class="btn btn-primary btn-block"><b>GO BACK</b></button></a>
                            </div>
                        </form>
