<div class="d-flex justify-content-end px-2">
    <?php echo '<div class="dropdown" >
        <button class="btn btn-secondary bg-dark text-light dropdown-toggle rounded-pill login_btn border border-light" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false"><img src="/Inventory/admin/' . $_SESSION['IMAGE'] . '" class="img pic_logo" alt="..."><strong> ' . strtoupper($_SESSION['USERNAME']) . '</strong>
        </button>
        <ul class="dropdown-menu text-center bg-dark text-light w_login" aria-labelledby="dropdownMenuButton1">
          <li><img src="/Inventory/admin/' . $_SESSION['IMAGE'] . '" class="img  pic_logo1" alt="..."><br><b>' . strtoupper($_SESSION['NAME']) . '</b></li>
          <hr> 
          ...
          <a class="text-info" href="/Inventory/partials/logout.php">
    ...
    <nav class="nav">
        <div>
            <div class="nav__brand">
                ...
                <a href="/Inventory/php/admin_panel.php" class="nav__logo nav">Admin Panel&nbsp</a>
            </div>
            <div class="nav__list">
